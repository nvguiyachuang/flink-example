 ...
 */
public class DebeziumJsonFilterSerializationSchema implements SerializationSchema<RowData> {
    ...
    public DebeziumJsonFilterSerializationSchema(
            RowType rowType,
    ...
    public byte[] serialize(RowData rowData) {
        try {
            switch (rowData.getRowKind()) {
                case INSERT:
                case UPDATE_AFTER:
                    genericRowData.setField(0, null);         // 历史数据
                    genericRowData.setField(1, rowData);            // 现有数据
                    genericRowData.setField(2, OP_INSERT);          // 操作类型
    ...
    public boolean equals(Object o) {
        ...
        DebeziumJsonFilterSerializationSchema that = (DebeziumJsonFilterSerializationSchema) o;
